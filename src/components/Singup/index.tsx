...
const Cadastrar: React.FC = () => {
    ...
    const passwordConfirmedRef = React.useRef({} as any)
    ...
    async function handleSubmit(ev: any) {
        ...
        if(passwordRef.current.value !== passwordConfirmedRef.current.value) {
            ...
            return setError('Senhas incompatives')
        }
    ...
    <Container >
        ...
        <Card>
            ...
            <form onSubmit={handleSubmit}>
                ...
                <InputElement>
                    <Input type="password" name="password" ref={passwordConfirmedRef}></Input>
